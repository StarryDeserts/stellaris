module stellaris::package_manager {
    ...
    public fun get_resource_address() :address {
        ...
        account::create_resource_address(&publisher_address, b"PACKAGE_MANAGER_V")
    }
    ...
    public entry fun initialize(publsiher: &signer) {
        ...
        let (signer, signer_cap) = account::create_resource_account(publsiher, b"PACKAGE_MANAGER_V");
